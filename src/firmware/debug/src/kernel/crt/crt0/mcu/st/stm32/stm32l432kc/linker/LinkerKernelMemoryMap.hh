...
extern "C"
{
	...
	extern const std::uint32_t __linker_sram_data_retained16k_kernel_lmaStart[];
	extern const std::uint32_t __linker_sram_data_retained16k_kernel_lmaPastEnd;
...
public:
		auto getInitialiserForRamSections(void) const
		{
			return ChainedInitialisation(
				...
				LinkerDataMemorySection(
					__linker_sram_data_retained16k_kernel_lmaStart,
					&__linker_sram_data_retained16k_kernel_lmaPastEnd,
