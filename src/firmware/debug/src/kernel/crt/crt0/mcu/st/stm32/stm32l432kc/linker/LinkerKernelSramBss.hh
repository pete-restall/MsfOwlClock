...
namespace smeg::kernel::crt::crt0::mcu::st::stm32::stm32l432kc::linker
{
	...
	{
public:
		consteval std::uint32_t *begin(void) const { return &__linker_sram_bss_kernel_start; }
		consteval std::uint32_t *end(void) const { return &__linker_sram_bss_kernel_pastEnd; }
	};
}
