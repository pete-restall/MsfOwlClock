#ifndef __SMEG_KERNEL_CRT_CRT0_MCU_MICROCHIP_PIC32C_PIC32CX1025SG41100_LINKER_LINKERAPPMEMORYMAP_HH
#define __SMEG_KERNEL_CRT_CRT0_MCU_MICROCHIP_PIC32C_PIC32CX1025SG41100_LINKER_LINKERAPPMEMORYMAP_HH
#include <cstdint>
...
extern "C"
{
	...
	extern std::uint32_t __linker_sram_bss_retained32k_app_start[];
	extern std::uint32_t __linker_sram_bss_retained32k_app_pastEnd;

	extern std::uint32_t __linker_sram_data_retained32k_app_start[];
	extern std::uint32_t __linker_sram_data_retained32k_app_pastEnd;

	extern const std::uint32_t __linker_sram_data_retained32k_app_lmaStart[];
	extern const std::uint32_t __linker_sram_data_retained32k_app_lmaPastEnd;

	extern std::uint32_t __linker_bsram_bss_app_start[];
	extern std::uint32_t __linker_bsram_bss_app_pastEnd;
	...
	public:
		auto getInitialiserForRamSections(void) const
		{
			return ChainedInitialisation(
				...
				LinkerBssMemorySection(__linker_sram_bss_retained32k_app_start, &__linker_sram_bss_retained32k_app_pastEnd),
				LinkerBssMemorySection(__linker_bsram_bss_app_start, &__linker_bsram_bss_app_pastEnd),
				LinkerDataMemorySection(
					__linker_sram_data_app_lmaStart,
					&__linker_sram_data_app_lmaPastEnd,
					__linker_sram_data_app_start),
				LinkerDataMemorySection(
					__linker_sram_data_retained32k_app_lmaStart,
					&__linker_sram_data_retained32k_app_lmaPastEnd,
					__linker_sram_data_retained32k_app_start));
		}
