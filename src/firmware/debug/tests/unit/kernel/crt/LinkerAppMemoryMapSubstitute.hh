#ifndef __SMEG_TESTS_UNIT_KERNEL_CRT_LINKERAPPMEMORYMAPSUBSTITUTE_HH
#define __SMEG_TESTS_UNIT_KERNEL_CRT_LINKERAPPMEMORYMAPSUBSTITUTE_HH
#include <concepts>
...
namespace smeg::tests::unit::kernel::crt
{
	...
	class LinkerAppMemoryMapSubstitute
	{
	private:
	...
	public:
		...
		{
			return LinkerAppMemoryMapSubstitute<T, TCodeSectionsInitialiser, TCodeSectionsFinaliser>(
				initialiser,
		...
		{
			return LinkerAppMemoryMapSubstitute<TRamSectionsInitialiser, T, TCodeSectionsFinaliser>(
		...
		{
			return LinkerAppMemoryMapSubstitute<TRamSectionsInitialiser, TCodeSectionsInitialiser, T>(
				this->ramSectionsInitialisableOrFactory,
				this->codeSectionsInitialisableOrFactory,
				finaliser);
		}
